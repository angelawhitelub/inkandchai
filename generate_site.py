...
#ch-wa-optin{-webkit-appearance:none;appearance:none;width:16px;height:16px;min-width:16px;flex:0 0 16px;padding:0;border-radius:3px;border:1px solid var(--gold-dim);background:var(--bg3);position:relative;cursor:pointer;transition:background 0.15s,border-color 0.15s;}
#ch-wa-optin:checked{background:var(--gold);border-color:var(--gold);}

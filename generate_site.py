...
@media(max-width:780px){
  .product-page{grid-template-columns:1fr;gap:2rem;padding:1.5rem 1rem 90px}
  .prod-cover-wrap{position:static;background:var(--bg);padding-bottom:0.8rem;border-bottom:1px solid var(--border);margin-bottom:0.5rem}
  .prod-cover{min-height:auto;padding:1.2rem}
  .prod-cover img{max-height:280px}

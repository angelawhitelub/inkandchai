...
.btn-partial{width:100%;font-family:'Montserrat',sans-serif;font-size:0.62rem;letter-spacing:0.16em;text-transform:uppercase;padding:1rem;background:#f7efe0;color:var(--gold);border:1px solid rgba(138,106,31,0.38);cursor:pointer;font-weight:500;transition:all 0.25s;margin-bottom:0.8rem;line-height:1.5;white-space:normal;overflow-wrap:anywhere;}
.btn-partial:hover{background:#f1e3c9;border-color:var(--gold);}

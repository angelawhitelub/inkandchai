  ...
  <div class="footer-top">
    ...
    <div>
      ...
      <ul class="footer-links">
        <li><a href="#">All Books</a></li><li><a href="#">New Arrivals</a></li>
        <li><a href="#">Bestsellers</a></li><li><a href="#">Collections</a></li>
        <li><a href="#">Gift Cards</a></li>
      </ul>
    </div>
    <div>
      ...
      <ul class="footer-links">
        ...
        <li><a href="#">Returns</a></li><li><a href="#">FAQs</a></li>
    ...
    <div>
      ...
      <ul class="footer-links">
        <li><a href="#">About Us</a></li><li><a href="#">Our Story</a></li>

...
*{box-sizing:border-box} body{margin:0;background:linear-gradient(115deg,rgba(138,106,31,.08) 0%,transparent 32%,transparent 72%,rgba(138,106,31,.06) 100%),repeating-linear-gradient(90deg,rgba(138,106,31,.03) 0 1px,transparent 1px 86px),var(--bg);color:var(--cream);font-family:Montserrat,sans-serif;font-weight:300} a{color:inherit}
.promo{width:min(920px,calc(100% - 24px));margin:.7rem auto .2rem;padding:.62rem 1rem;text-align:center;border:1px solid var(--border);border-radius:999px;background:rgba(250,247,242,.78);box-shadow:0 10px 28px rgba(70,52,24,.08),inset 0 1px rgba(255,255,255,.62);backdrop-filter:blur(18px) saturate(1.2);font-size:.68rem;letter-spacing:.12em;text-transform:uppercase;color:var(--muted)} .promo strong{color:var(--gold)}
nav{width:min(1180px,calc(100% - 28px));margin:.75rem auto 0;display:flex;align-items:center;justify-content:space-between;padding:1rem clamp(1rem,4vw,4rem);border:1px solid var(--border);border-radius:999px;background:rgba(250,247,242,.74);box-shadow:0 18px 55px rgba(70,52,24,.12),inset 0 1px rgba(255,255,255,.62);backdrop-filter:blur(24px) saturate(1.25);position:sticky;top:12px;z-index:5}.logo{font-family:"Cormorant Garamond",serif;font-size:1.5rem;color:var(--gold);text-decoration:none}.back{font-size:.62rem;letter-spacing:.2em;text-transform:uppercase;color:var(--muted);text-decoration:none}
.wrap{max-width:1260px;margin:0 auto;padding:clamp(1.2rem,4vw,4rem) 1rem 4rem;display:grid;grid-template-columns:minmax(320px,.95fr) 1.05fr;gap:clamp(1.4rem,4vw,4rem);align-items:start}.cover{background:rgba(255,255,255,.58);border:1px solid var(--border);border-radius:28px;padding:clamp(1rem,2.5vw,1.8rem);display:flex;align-items:center;justify-content:center;box-shadow:0 24px 70px rgba(70,52,24,.1),inset 0 1px rgba(255,255,255,.74)}.cover img{max-width:100%;max-height:600px;object-fit:contain;box-shadow:0 24px 64px rgba(70,52,24,.2)}
...
.trust{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:.7rem;margin:1.2rem 0}.trust span{border:1px solid var(--border);border-radius:22px;background:rgba(138,106,31,.06);padding:.75rem;color:var(--cream);font-size:.78rem;box-shadow:inset 0 1px rgba(255,255,255,.5)}.actions{display:grid;grid-template-columns:1fr 1fr;gap:.8rem;margin:1.3rem 0}button{font:700 .68rem Montserrat,sans-serif;letter-spacing:.2em;text-transform:uppercase;padding:1rem;border:1px solid var(--gold);border-radius:999px;cursor:pointer;min-height:52px;transition:transform .2s ease,filter .2s ease,box-shadow .2s ease}button:hover{transform:translateY(-1px);filter:brightness(1.05)}.primary{background:var(--gold);color:#fff;box-shadow:0 14px 30px rgba(138,106,31,.18),inset 0 1px rgba(255,255,255,.18)}.secondary{background:rgba(138,106,31,.06);color:var(--gold)}

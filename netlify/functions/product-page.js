...
html[data-theme="light"]{--bg:#faf7f2;--panel:#fff;--gold:#7a5a12;--gold-light:#5f4610;--copper:#7d4f2c;--cream:#241c14;--muted:#4e4032;--border:rgba(138,106,31,.28);--ink-blue:#e8edf0;--glass-bg:rgba(250,247,242,.78);--glass-border:rgba(138,106,31,.28);--glass-shadow:0 18px 55px rgba(70,52,24,.12);--glass-highlight:inset 0 1px rgba(255,255,255,.62)}
html{--ship-free:#2f6e37}html:not([data-theme="light"]){--ship-free:#6dbf6d}html:not([data-theme="light"]){color-scheme:dark}
...
.ship-by-box{display:flex;align-items:flex-start;gap:.65rem;padding:.75rem 1rem;margin:1.2rem 0 0;background:rgba(109,191,109,.07);border:1px solid rgba(109,191,109,.22);border-radius:14px}.ship-by-icon{font-size:1.15rem;line-height:1;flex-shrink:0;margin-top:.1rem}.ship-by-text{display:flex;flex-direction:column;gap:.18rem}.ship-by-label{font-size:.58rem;letter-spacing:.2em;text-transform:uppercase;color:#2f6e37}html:not([data-theme="light"]) .ship-by-label{color:#6dbf6d}.ship-by-date{font-size:.95rem;font-weight:600;color:var(--cream)}.ship-by-sub{font-size:.68rem;color:var(--muted);margin-top:.1rem}.eta-block{margin-top:.5rem;padding-top:.5rem;border-top:1px solid rgba(109,191,109,.18)}.eta-head{font-size:.55rem;letter-spacing:.2em;text-transform:uppercase;color:#2f6e37;margin-bottom:.28rem}html:not([data-theme="light"]) .eta-head{color:#6dbf6d}.eta-row{display:flex;justify-content:space-between;gap:1.2rem;font-size:.72rem;line-height:1.75;color:var(--muted)}.eta-zone{white-space:nowrap}.eta-date{color:var(--cream);font-weight:600;white-space:nowrap}.eta-pin-row{display:flex;gap:0.4rem;margin:0.35rem 0 0.25rem}.eta-pin-input{flex:1;min-width:0;padding:0.4rem 0.55rem;font-size:0.72rem;letter-spacing:0.06em;color:var(--cream);background:rgba(0,0,0,0.18);border:1px solid rgba(109,191,109,0.28);border-radius:8px}.eta-pin-input:focus{outline:none;border-color:#6dbf6d}.eta-pin-btn{padding:0.4rem 0.7rem;font-size:0.6rem;letter-spacing:0.14em;color:#0d0b08;background:#6dbf6d;border:0;border-radius:8px;cursor:pointer}.eta-pin-btn:hover{opacity:0.88}.eta-pin-result{font-size:0.7rem;line-height:1.65;color:var(--muted);min-height:1rem}.eta-pin-date strong{color:var(--cream);font-weight:600}.eta-pin-place{opacity:0.8}.eta-pin-cod{margin-top:0.1rem;opacity:0.85}.eta-pin-error{color:#e0a060}.eta-pin-loading{opacity:0.7}.eta-pin-geo{margin:0 0 0.3rem;padding:0.3rem 0;font-size:0.64rem;letter-spacing:0.06em;color:#6dbf6d;background:none;border:0;cursor:pointer;text-align:left}.eta-pin-geo:hover{text-decoration:underline}.eta-pin-geo:disabled{opacity:0.5;cursor:default;text-decoration:none}.theme-btn{background:none;border:1px solid var(--border);color:var(--gold);border-radius:999px;width:34px;height:34px;min-height:34px;padding:0;font-size:1rem;cursor:pointer;line-height:1;letter-spacing:normal;text-transform:none}.theme-btn:hover{border-color:var(--gold)}.vid-badge{position:absolute;top:10px;left:10px;z-index:2;pointer-events:none;font-size:.56rem;letter-spacing:.18em;text-transform:uppercase;color:var(--gold-light);background:rgba(13,11,8,.72);border:1px solid var(--glass-border);border-radius:999px;padding:.32rem .6rem;backdrop-filter:blur(8px)}
...
<nav><a class="logo" href="/">Ink &amp; Chai</a><form class="nav-search" action="/" method="get" role="search"><input type="search" name="q" placeholder="Search books&hellip;" aria-label="Search books" autocomplete="off"/><button type="submit" aria-label="Search">&#128269;</button></form><a class="back" href="/books/">All Books</a><button class="theme-btn" onclick="(function(){var d=document.documentElement;var light=d.getAttribute('data-theme')==='light';if(light){d.removeAttribute('data-theme')}else{d.setAttribute('data-theme','light')}try{localStorage.setItem('iac_theme',light?'dark':'light')}catch(e){}})()" title="Toggle theme" aria-label="Toggle light or dark theme">&#9788;</button></nav>
<main class="wrap">
  ...
  <section>
    ...
    <div id="addedBanner" style="display:none;margin-top:0.9rem;padding:0.85rem 1rem;border:1px solid rgba(109,191,109,0.5);background:rgba(109,191,109,0.10);border-radius:14px;color:#2f6e37;font-size:0.78rem;line-height:1.55;text-align:center;">
      ✓ Added to cart.

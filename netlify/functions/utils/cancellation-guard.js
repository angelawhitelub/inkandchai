 ...
 *
 * ONE floor, for both. A seven-day floor for no-AWB orders was tried and
 * withdrawn: ten days is the store's rule for an unshipped order, and a
 * second threshold only created a window where the two paths disagreed.
 */
